...
function generateBilanDocx(data, year) {
  const { monthlyData, results, totalEC, finalCC, totalIC } = data;
        ...
        children: [
          ...
          new TableCell({
            ...
            children: [
              new Paragraph({
                ...
                children: [new TextRun({ text: `${row.ER} FRCFA`, size: 20 })],
              }),
            ],
          }),
          new TableCell({
            ...
            children: [
              new Paragraph({
                alignment: AlignmentType.RIGHT,
                children: [new TextRun({ text: `${row.IR} FRCFA`, size: 20 })],
              }),
            ],
          }),
          new TableCell({
          ...
          new TableCell({
            ...
            children: [
              new Paragraph({
                alignment: AlignmentType.RIGHT,
                children: [new TextRun({ text: `${row.EC} FRCFA`, size: 20 })],
              }),
            ],
          }),
          new TableCell({
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            alignment: AlignmentType.CENTER,
            spacing: { after: 400 },
            children: [new TextRun({ text: `Bilan Financier Annuel ${year}` })],
          }),
                ...
                children: [
                  ...
                  new TableCell({
                    ...
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({ text: "Capital Final (CC)", size: 22 }),
                        ],
                      }),
                      new Paragraph({
                        spacing: { before: 100 },
              ...
              new TableRow({
                children: [
                  ...
                  new TableCell({
                    ...
                    children: [
                      new Paragraph({
                        children: [new TextRun({ text: "Période", size: 22 })],
                      }),
                      new Paragraph({
                        spacing: { before: 100 },
                        children: [
