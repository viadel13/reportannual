...
//     } else {
//       alert(
//         "Veuillez remplir l'Épargne Client (EC) pour tous les mois de janvier à octobre",
//       );
//     }
//   };
//
...
//       } else {
//         const IR_prev = Math.floor(
//           parseFloat(monthlyData[mois[index - 1]].ir) || 0,
//         );
//
...
//         const nextEC =
//           index < 9
//             ? Math.floor(parseFloat(monthlyData[mois[index + 1]].ec) || 0)
//             : 0;
//
...
//       sx={{
//         minHeight: "100vh",
//         background: "linear-gradient(to bottom right, #e0f2f1, #bbdefb)",
//         padding: 1,
//       }}
//     >
...
//               <CalendarToday
//                 sx={{ fontSize: 36, color: "#4caf50", marginRight: 2 }}
//               />
//               <Box>
//                 <Typography
//                   variant="h5"
...
//                         onChange={(e) =>
//                           handleMonthlyChange(month, "ec", e.target.value)
//                         }
//                         placeholder="FRCFA"
//                         variant="outlined"
//                         sx={{ marginBottom: 1 }}
...
//                             <ExpandMore
//                               sx={{
//                                 transform: expandedMonths[month]
//                                   ? "rotate(180deg)"
//                                   : "rotate(0deg)",
//                                 transition: "0.3s",
//                               }}
...
//                             onChange={(e) =>
//                               handleMonthlyChange(month, "er", e.target.value)
//                             }
//                             placeholder="FRCFA"
//                             variant="outlined"
//                             sx={{ marginBottom: 1 }}
...
//                             onChange={(e) =>
//                               handleMonthlyChange(month, "ir", e.target.value)
//                             }
//                             placeholder="FRCFA"
//                             variant="outlined"
//                           />
...
//                             }}
//                           >
//                             Valeurs par défaut: ER={monthlyData[month].er}, IR=
//                             {monthlyData[month].ir}
//                           </Typography>
//                         </Box>
//                       </Collapse>
//                     </Paper>
...
//                     <strong>TR:</strong> Total Réunion
//                   </Typography>
//                 </Grid>
//                 <Grid size={{ xs: 6, sm: 4, md: 2 }}>
//                   <Typography variant="body2">
//                     <strong>CC:</strong> Capital Client
//                   </Typography>
//                 </Grid>
//                 <Grid size={{ xs: 6, sm: 4, md: 2 }}>
//                   <Typography variant="body2">
//                     <strong>IR:</strong> Intérêt Réunion
//                   </Typography>
//                 </Grid>
//                 <Grid size={{ xs: 6, sm: 4, md: 2 }}>
//                   <Typography variant="body2">
//                     <strong>IC:</strong> Intérêt Client
//                   </Typography>
//                 </Grid>
//                 <Grid size={{ xs: 6, sm: 4, md: 2 }}>
//                   <Typography variant="body2">
//                     <strong>EC:</strong> Épargne Client
//                   </Typography>
//                 </Grid>
//                 <Grid size={{ xs: 6, sm: 4, md: 2 }}>
//                   <Typography variant="body2">
//                     <strong>ER:</strong> Épargne Réunion
//                   </Typography>
//                 </Grid>
//               </Grid>
//             </Paper>
...
//                 alignItems: { xs: "flex-start", sm: "flex-start", md: "none" },
//               }}
//             >
//               <Typography
//                 variant="h5"
...
//                 <Paper
//                   sx={{ padding: 2, backgroundColor: "#f3e5f5", boxShadow: 2 }}
//                 >
//                   <Typography variant="body1" sx={{ color: "#555" }}>
//                     Total Épargne Client
//                   </Typography>
//                   <Typography
//                     variant="h5"
...
//                     {mois
//                       .reduce(
//                         (sum, m) => sum + (parseInt(monthlyData[m].ec) || 0),
//                         0,
//                       )
//                       .toFixed(0)}{" "}
//                     FRCFA
...
//               <Grid size={{ xs: 12, sm: 6, md: 4 }}>
//                 <Paper
//                   sx={{ padding: 2, backgroundColor: "#e3f2fd", boxShadow: 2 }}
//                 >
//                   <Typography variant="body1" sx={{ color: "#555" }}>
//                     Capital Final (CC)
//                   </Typography>
...
//               <Grid size={{ xs: 12, sm: 6, md: 4 }}>
//                 <Paper
//                   sx={{ padding: 2, backgroundColor: "#c8e6c9", boxShadow: 2 }}
//                 >
//                   <Typography variant="body1" sx={{ color: "#555" }}>
//                     Intérêts Totaux (IC)
//                   </Typography>
...
//                   >
//                     {calculateResults()
//                       .reduce((sum, row) => sum + parseFloat(row.IC), 0)
//                       .toFixed(0)}{" "}
//                     FRCFA
//                   </Typography>
//                 </Paper>
...
//               <Typography
//                 variant="h6"
//                 sx={{ fontWeight: "bold", marginBottom: 2, color: "#2e7d32" }}
//               >
...
//                   <br />• Autres mois: TR = TR(mois précédent) + IR(mois
//                   précédent) + ER(mois actuel)
//                 </Typography>
//                 <Typography variant="body2" sx={{ marginBottom: 1 }}>
...
//                   <br />• Autres mois: IC = (CC du mois précédent × IR du mois)
//                   ÷ TR
//                 </Typography>
//                 <Typography variant="body2">
...
//                     Capital Client (CC):
//                   </strong>
//                   <br />• Janvier à Septembre: CC = CC(mois précédent) + IC(mois
//                   actuel) + EC(mois suivant)
...
export default function Home() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const totalEC = mois.reduce(
        (sum, m) => sum + (parseInt(monthlyData[m].ec) || 0),
        0,
      );
      const finalCC = results[9]?.CC || "0";
      const totalIC = results
        .reduce((sum, row) => sum + parseFloat(row.IC), 0)
        .toFixed(0);
      ...
      a.href = url;
      a.download = `Bilan_Financier_${currentYear}.docx`;
      ...
      alert("Une erreur est survenue lors de l'export du document");
    } finally {
